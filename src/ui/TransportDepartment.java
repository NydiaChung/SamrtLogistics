...
*---------------------------------------------------------*
* 2020年4月26日     zongyue           v1.0.0           TransportDepartment.java    
*
* @Description: 
*/
public class TransportDepartment extends JFrame{
	public TransportDepartment(){
		 ...
		 JLabel jl0 = new JLabel("交通运输");
		 jl0.setBounds(200,30,600,100);
		 jl0.setFont(new Font("宋体", Font.BOLD, 30));
		 add(jl0);
		 
		 JLabel jl_needInfo =new JLabel("运输需求信息:");
		 jl_needInfo.setBounds(60,150,150,30);
		 jl_needInfo.setFont(new Font("宋体", Font.PLAIN, 20));
		 add(jl_needInfo);
		 JTextField jt_needInfo = new JTextField();
		 jt_needInfo.setBounds(200,150,300,30);
		 add(jt_needInfo);
		
		 JLabel jl_carStatistics = new JLabel("车辆运营数据:");
		 jl_carStatistics.setBounds(60,200,150,30);
		 jl_carStatistics.setFont(new Font("宋体", Font.PLAIN, 20));
		 add(jl_carStatistics);
		 JTextField jt_carStatistics = new JTextField("true");
		 jt_carStatistics.setBounds(200,200,300,30);
		 add(jt_carStatistics);
		 
		 JLabel jl_border = new JLabel("出入境信息:");
		 jl_border.setBounds(60,250,150,30);
		 jl_border.setFont(new Font("宋体", Font.PLAIN, 20));
		 add(jl_border);
		 JTextField jt_border = new JTextField();
		 jt_border.setBounds(200,250,300,30);
		 add(jt_border);
					...
					try{
						...
						if(cur.size()!=0){
							...
							while(cur.hasNext()){
								...
								//显示
								jt_needInfo.setText((String) tradeCompany.get("carGoodsTrace"));
								jt_carStatistics.setText((String) tradeCompany.get("orderOnline"));
			 ...
			 jb2.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					try{
						...
						String carGoodsTrace=jt_needInfo.getText();
						String orderOnline=jt_carStatistics.getText();
