...
*---------------------------------------------------------*
* 2020年4月26日     zongyue           v1.0.0           GoodsAgent.java    
*
* @Description: 
*/
public class GoodsAgent extends JFrame{
	...
	*/
		public GoodsAgent(){
			 ...
			 JLabel jl_policy = new JLabel("政府政策:");
			 jl_policy.setBounds(100,200,100,30);
			 jl_policy.setFont(new Font("宋体", Font.PLAIN, 20));
			 add(jl_policy);
			 JTextField jt_policy = new JTextField("true");
			 jt_policy.setBounds(200,200,300,30);
			 add(jt_policy);
			 ...
			 JLabel jl_need = new JLabel("<html>相关企业<br>需求信息:</html>");
			 jl_need.setBounds(100,300,100,50);
			 jl_need.setFont(new Font("宋体", Font.PLAIN, 20));
			 add(jl_need);
			 JTextField jt_need = new JTextField();
			 jt_need.setBounds(200,300,300,30);
			 add(jt_need);
			 
			 JLabel jl_pay = new JLabel("在线支付:");
			 jl_pay.setBounds(100,350,100,30);
			 jl_pay.setFont(new Font("宋体", Font.PLAIN, 20));
			 add(jl_pay);
			 JTextField jt_pay = new JTextField();
			 jt_pay.setBounds(200,350,300,30);
			 add(jt_pay);
					...
					try{
						...
						if(cur.size()!=0){
							...
							while(cur.hasNext()){
								...
								jt_policy.setText((String) transportCompany.get("carGoodsMatch"));
								jt_carGoodsTrace.setText((String) transportCompany.get("carGoodsTrace"));
								jt_need.setText((String) transportCompany.get("deviceInfo"));
								jt_pay.setText((String) transportCompany.get("transit"));
				...
				public void actionPerformed(ActionEvent e) {
					...
					try{
						...
						if(cur.size()!=0){
							...
							String carGoodsMatch=jt_policy.getText();
							String carGoodsTrace=jt_carGoodsTrace.getText();
							String deviceInfo=jt_need.getText();
							String transit=jt_pay.getText();
				...
				public void actionPerformed(ActionEvent e) {
					...
					try {
						...
						while(cur.hasNext()){
							...
							//显示
							jt_policy.setText((String) transportCompanyDomain.get("carGoodsMatch"));
							...
							jt_need.setText((String) transportCompanyDomain.get("deviceInfo"));
							jt_pay.setText((String) transportCompanyDomain.get("transit"));
