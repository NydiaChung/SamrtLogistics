...
*---------------------------------------------------------*
* 2020年4月26日     zongyue           v1.0.0           TransportDepartmentDao.java    
*
* @Description: 
*/
public class TransportDepartmentDao {
	...
	public void updateTransportDepartment(TransportDepartmentDomain transportDepartmentDomain) throws Exception {
		...
		//添加数据
		basicDBObject1.put("id", transportDepartmentDomain.getId());
		basicDBObject.put("needInfo", transportDepartmentDomain.getNeedInfo());
		basicDBObject.put("carStatistics", transportDepartmentDomain.getCarStatistics());
		basicDBObject.put("border", transportDepartmentDomain.getBorder());
		//使用集合连接将数据库插入到数据库中
	...
	public void addTransportDepartment(TransportDepartmentDomain transportDepartmentDomain) throws Exception {
		...
		//获取集合连接
				...
				DBObject basicDBObject = new BasicDBObject();
				//添加数据
				basicDBObject.put("id", transportDepartmentDomain.getId());
				basicDBObject.put("needInfo", transportDepartmentDomain.getNeedInfo());
				basicDBObject.put("carStatistics", transportDepartmentDomain.getCarStatistics());
				basicDBObject.put("border", transportDepartmentDomain.getBorder());
				//使用集合连接将数据库插入到数据库中
